                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" name="gst_no" class="form-control" placeholder="GST Number" required value="{{$invoice->gst_no}}">
                        </div>
                        <div class="form-group col-md-4">
                            <label class="required">GST Address</label>
                            <input type="text" name="gst_address" class="form-control" placeholder="GST Address" required value="{{$invoice->gst_address}}">
                        </div>
                    </div>
                    <div class="row">

            ...
            <form action="" method="GET" id="shareInvoice">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="custEmail" class="required">Email</label>
                        <input type="email" name="email" class="form-control" id="custEmail" placeholder="Enter Email" required>
                    </div>
                </div>
...
<script>
    function getInvoiceId(el){
        ...
        $('#custEmail').val($(el).attr('custEmail'));
    }
</script>

            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-default">
                        <form method="POST" action="{{ url('admin/add-associate') }}" enctype="multipart/form-data" id="addAssociate">@csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-md-4">
            	                        <label class="required">Associates Name</label>
            	                        <input type="text" name="associates_name" class="form-control" placeholder="Enter Associates Name" required>
                          	        </div>
                                    <div class="form-group col-md-4">
            	                        <label class="required">Associates Email</label>
            	                        <input type="email" name="associates_email" class="form-control" placeholder="Enter Associates Email" required>
                          	        </div>
                                    <div class="form-group col-md-4">
            	                        <label class="required">Associates Contact</label>
            	                        <input type="text" name="associates_contact" class="form-control" placeholder="Enter Associates Contact" required>
                          	        </div>

...
<div class="content-wrapper">
    <section class="content-header pb-1">
        <div class="container-fluid">
            <div class="row mb-0">
                <div class="col-sm-6">
                    <h4>Testimonials list <span class="badge badge-dark">{{$testimonials->total()}}</span></h4>
                </div>
                <div class="col-sm-6 text-right">
                    <a href="{{ url('/admin/add-testimonial') }}" class="btn btn-dark text-white"><i class="fa fa-plus-circle"></i> Add Testimonial</a>
                </div>
            </div>
        </div>
    </section>

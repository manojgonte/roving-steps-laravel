        ...
        <center style="width: 100%; background-color: #f1f1f1;">
            ...
            <div style="max-width: 600px; margin: 0 auto;" class="email-container">
                ...
                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: auto;">
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td width="100%" class="logo" style="text-align: center;">
                                        <a href="#"><img src="{{public_path('img/logo/logo_trans.png')}}" style="width: 200px;" alt="logo" /></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <!-- end tr -->
                    <tr>
                        <td valign="middle" class="hero bg_white" style="background-image: url({{public_path('img/tours/tour_itinerary/'.$tour['image'])}}); background-size: cover; height: 400px;">
                        </td>
                    </tr>
                    <!-- end tr -->
                    <tr>
                                            ...
                                            <tr>
                                                    ...
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td class="text-services">
                                                                <h3 style="border-bottom: 1px solid #aaa;">Price</h3>
                                                                <h5 style="margin-bottom: 0">Adult: ₹{{number_format($tour['adult_price'])}}</h5>
                                                                <h5>Child: ₹{{number_format($tour['child_price'])}}</h5>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td valign="top" width="33.333%" style="padding-top: 20px; background: rgba(0,0,0,.08);" class="services">
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td class="text-services">
                                                                <h3 style="border-bottom: 1px solid #aaa;">Date</h3>
                                                ...
                                                <td valign="top" width="33.333%" style="padding-top: 20px;" class="services">
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td class="text-services">
                                                                <h3 style="border-bottom: 1px solid #aaa;">Duration</h3>
                                ...
                                <tr>
                                    <td class="primary email-section" style="text-align:center;">
                                        <div class="heading-section heading-section-white">
                                            ...
                                            <p>
                                                <a href="{{url('/tour-details/'.$tour['id']).'/'.Str::slug($tour['tour_name'])}}" class="btn btn-white-outline">Read More</a>
                                            </p>
                                        </div>
                                    </td>
                                </tr>
